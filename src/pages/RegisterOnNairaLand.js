...
const RegisterOnNairaLand = () => {
  return (
    <div>
        ...
        <h4>Submit Your Email To Join Nairaland</h4>
        <form method="GET" action="/do_confirm_email">
            
                </form>

                
<div class="w">Before you can join Nairaland, we need to verify your email address. Please enter it below:<br/>

    <tr/>
    </div>
        <div className=''><label><b>Email</b>: <input name="email" type="text"/></label> <input type="submit" value="Submit"/>
        </div>
...
export default RegisterOnNairaLand